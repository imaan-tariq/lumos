...
import com.google.firebase.auth.FirebaseAuth;
    ...
    public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
           ...
           /* sp = getSharedPreferences("buttonSignUp",MODE_PRIVATE);
            if(sp.getBoolean("buttonSignUp",false)) {
                registerUser();
            }*/
    ...
    authClient.createUser(email, password, new SimpleLoginAuthenticatedHandler() {
        ...
        public void onClick(View view) {
            if(view == buttonSignUp){
                registerUser();
               // sp.edit().putBoolean("buttonSigUp", true).apply();
            }

            if(view == signIn){
                //will open login activity
                startActivity(new Intent(this, SignInActivity.class));
               // sp.edit().putBoolean("buttonSignIn", true).apply();
            }
        }
